...
func TestAWG3EncryptedTraffic(t *testing.T) {
	testEncryptedTraffic(t, "s1=16\ns2=16\ns3=16\ns4=16\nheader_protection_key="+strings.Repeat("ab", 32)+"\ncontent_padding_addition=8-32\nrandom_trailers=true\ndisable_cookies=true\n", false)
}
func TestAWG3Parameters(t *testing.T) {
	p, err := validateParameters("s1=12\ns2=12\ns3=12\ns4=12\nheader_protection_key=AQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQE=\nrekey_timeout=4-8\npersistent_keepalive_interval=22-33\n", 1280)
	if err != nil || !strings.Contains(p, "header_protection_key="+strings.Repeat("01", 32)) {
		t.Fatalf("AWG3 validation: %v", err)
	}
	for _, bad := range []string{"header_protection_key=AQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQEBAQE=\n", "rekey_timeout=8-4\n", "disable_cookies=bad\n"} {
