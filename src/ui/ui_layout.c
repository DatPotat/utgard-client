...
void layout(HWND hwnd)
{
...

    {
        ...
        ShowWindow(g_set_upd_now, sp);
        {
            ...
            MoveWindow(g_set_v_utgard,  x, y, S(100), S(24), TRUE);  x += S(100) + S(16);
            MoveWindow(g_set_v_singbox, x, y, S(116), S(24), TRUE);  x += S(116) + S(16);
            MoveWindow(g_set_v_awg,     x, y, g_awg_ready ? S(130) : S(220), S(24), TRUE);
            ShowWindow(g_set_v_utgard,  sp);
            ShowWindow(g_set_v_singbox, sp);
            ShowWindow(g_set_v_awg,     sp);
        }
